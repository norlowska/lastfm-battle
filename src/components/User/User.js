...
export default function User(props) {
  ...
  var nowPlaying = user.nowPlaying ? (
    <div className="now-playing">
      ...
      <span className="now-playing-song">{user.nowPlaying.name}</span>
    </div>
  ) : (
  ...
  return (
    <div className="user-container">
      ...
      {nowPlaying}
      <div className="scrobbles-total">
        {playcount}{" "}
        {wins.includes("total") ? (
          <img
            className="trophy"
            src="/trophy.svg"
            alt="Total playcount category winner's trophy"
          />
        ) : (
          ""
        )}
      </div>
      <div className="scrobbles-this-year">
        {scrobblesThisYear}{" "}
        {wins.includes("scrobblesThisYear") ? (
          <img
            className="trophy"
            src="/trophy.svg"
            alt="Scrobbles this year category winner's trophy"
          />
        ) : (
          ""
        )}
      </div>
      <div className="scrobbles-this-month">
        {scrobblesThisMonth}{" "}
        {wins.includes("scrobblesThisMonth") ? (
          <img
            className="trophy"
            src="/trophy.svg"
            alt="Scrobbles this month category winner's trophy"
          />
        ) : (
          ""
        )}
      </div>
      <div className="scrobbles-this-week">
        {scrobblesThisWeek}{" "}
        {wins.includes("scrobblesThisWeek") ? (
          <img
            className="trophy"
            src="/trophy.svg"
            alt="Scrobbles this week category winner's trophy"
          />
        ) : (
          ""
        )}
